...
export const metadata: Metadata = {
  title: "Webild - AI Website Builder for Modern Teams",
  description: "Build stunning websites in minutes with Webild, the ChatGPT for web design. AI-powered, no coding required.",
  keywords: "AI website builder, website generator, ChatGPT for web design, no-code platform, web development tool",
  metadataBase: new URL("https://webild.com"),
  alternates: {
    canonical: "https://webild.com"
  },
  openGraph: {
    title: "Webild - AI Website Builder",
    description: "Build beautiful websites faster with AI. No coding required.",
    siteName: "Webild",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764873732785-zsf3yimh.jpg",
        alt: "Webild AI Website Builder"
      }
    ]
  },
  twitter: {
    ...
    title: "Webild - AI Website Builder",
    description: "The ChatGPT for website creation. Build faster.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764873732785-zsf3yimh.jpg"]
  },
  robots: {
    index: true,
    follow: true
